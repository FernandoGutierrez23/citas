@extends('layouts.main', ['class' => 'off-canvas-sidebar', 'activePage' => 'register', 'title' => __('MENU DE REGISTRO')])
      ...
      <form class="form" method="POST" action="{{ route('register') }}">
        ...
        <div class="card card-login card-hidden mb-3">
          <div class="card-header card-header-primary text-center">
            <h4 class="card-title"><strong>{{ __('FORMULARIO DE REGISTRO') }}</strong></h4>
          ...
          <div class="card-body ">
            <p class="card-description text-center">{{ __('Completa los datos para registrarte') }}</p>
            ...
            <!-- AGREGAMOS EL CAMPO PARA EL NOMBRE DE USUARIO-->
            ...
            <div class="bmd-form-group{{ $errors->has('password_confirmation') ? ' has-danger' : '' }} mt-3">
              <div class="input-group">
                ...
                <input type="password" name="password_confirmation" id="password_confirmation" class="form-control" placeholder="{{ __('Confirme su contraseña') }}" required autocomplete="new-password">
              </div>
            ...
            <!--CÓDIGO PARA EL CAPTCHA-->
            <div class="mr-auto ml-3 mt-3">
              {!!NoCaptcha::renderJs()!!}
              {!!NoCaptcha::display()!!}
